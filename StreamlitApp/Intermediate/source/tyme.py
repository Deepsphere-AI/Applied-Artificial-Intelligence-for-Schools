...
def tyme():
    ...
    vAR_st.markdown("<p style='text-align: center; color: black; font-size:20px;'><span style='font-weight: bold'>Problem Statement: </span>Application for time conversion</p>", unsafe_allow_html=True)
    ...
    with col2:
        sel=vAR_st.selectbox("",("Select","Standard time to railway time","Railway time to standard time","Time interval"))
    def cleartext():
